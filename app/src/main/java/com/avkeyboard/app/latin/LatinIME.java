...
import com.avkeyboard.app.accessibility.AccessibilityUtils;
import com.avkeyboard.app.compat.ConfigurationCompatKt;
import com.avkeyboard.app.compat.EditorInfoCompatUtils;
import com.avkeyboard.app.compat.ImeCompat;
import com.avkeyboard.app.event.HapticEvent;
import com.avkeyboard.app.keyboard.KeyboardActionListener;
import com.avkeyboard.app.keyboard.KeyboardActionListenerImpl;
import com.avkeyboard.app.keyboard.emoji.EmojiPalettesView;
import com.avkeyboard.app.keyboard.emoji.EmojiSearchActivity;
...
import com.avkeyboard.app.latin.common.InsetsOutlineProvider;
import com.avkeyboard.app.dictionarypack.DictionaryPackConstants;
import com.avkeyboard.app.event.Event;
import com.avkeyboard.app.event.InputTransaction;
import com.avkeyboard.app.keyboard.Keyboard;
import com.avkeyboard.app.keyboard.KeyboardId;
import com.avkeyboard.app.keyboard.KeyboardLayoutSet;
import com.avkeyboard.app.keyboard.KeyboardSwitcher;
import com.avkeyboard.app.keyboard.MainKeyboardView;
import com.avkeyboard.app.latin.SuggestedWords.SuggestedWordInfo;
import com.avkeyboard.app.latin.common.ColorType;
import com.avkeyboard.app.latin.common.Constants;
import com.avkeyboard.app.latin.common.CoordinateUtils;
import com.avkeyboard.app.latin.common.InputPointers;
import com.avkeyboard.app.latin.common.ViewOutlineProviderUtilsKt;
import com.avkeyboard.app.latin.define.DebugFlags;
import com.avkeyboard.app.latin.inputlogic.InputLogic;
import com.avkeyboard.app.latin.personalization.PersonalizationHelper;
import com.avkeyboard.app.latin.settings.Settings;
import com.avkeyboard.app.latin.settings.SettingsValues;
import com.avkeyboard.app.latin.suggestions.SuggestionStripView;
import com.avkeyboard.app.latin.suggestions.SuggestionStripViewAccessor;
import com.avkeyboard.app.latin.touchinputconsumer.GestureConsumer;
import com.avkeyboard.app.latin.utils.ColorUtilKt;
import com.avkeyboard.app.latin.utils.GestureDataGatheringKt;
import com.avkeyboard.app.latin.utils.InlineAutofillUtils;
import com.avkeyboard.app.latin.utils.InputMethodPickerKt;
import com.avkeyboard.app.latin.utils.JniUtils;
import com.avkeyboard.app.latin.utils.KtxKt;
import com.avkeyboard.app.latin.utils.LeakGuardHandlerWrapper;
import com.avkeyboard.app.latin.utils.Log;
import com.avkeyboard.app.latin.utils.RecapitalizeMode;
import com.avkeyboard.app.latin.utils.StatsUtils;
import com.avkeyboard.app.latin.utils.StatsUtilsManager;
import com.avkeyboard.app.latin.utils.SubtypeLocaleUtils;
import com.avkeyboard.app.latin.utils.SubtypeSettings;
import com.avkeyboard.app.latin.utils.SubtypeState;
import com.avkeyboard.app.latin.utils.ToolbarMode;
import com.avkeyboard.app.settings.SettingsActivity2;
import kotlin.Unit;
...
public class LatinIME extends InputMethodService implements
    ...
    public void onCreate() {
        ...
        mVoiceInputController = new VoiceInputController(this, text -> {
            ...
            final MainKeyboardView mkv = mKeyboardSwitcher.getMainKeyboardView();
            if (mkv != null) {
                mkv.setVoiceKeyRecording(state == VoiceInputController.State.RECORDING);
            }
            return kotlin.Unit.INSTANCE;
        });
